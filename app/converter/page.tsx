...
type Stage = "pick-options" | "converting" | "done";
...
export default function Home() {
  const [stage,       setStage]       = useState<Stage>("pick-options");
  ...
  const addFiles = useCallback((files: File[]) => {
    ...
    let detectedCat: Category | undefined;
  ...
  useEffect(() => {
    if (stage !== "pick-options") mainRef.current?.focus();
  }, [stage]);
